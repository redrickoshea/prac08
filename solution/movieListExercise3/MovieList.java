...
import static movieListExercise3.OscarDB.oscarWinner;

import movieListExercise3.MovieListException;
 ...
 * up, and where Oscar winners are noted.
 * 
...
public class MovieList {
	...
	/**
	 * Returns the movies in the list, sorted alphabetically, with
	 * Oscar winners indicated.
	...
	public String getList() throws MovieListException {
		...
		for (String movieName : movieList.keySet()) { // ascending natural order
			wholeList += (oscarWinner(movieName) ? "Oscar winner: " : ""); // TODO - dummy code!
			wholeList += movieName + "\n"; 
		}
		return wholeList;
	}
